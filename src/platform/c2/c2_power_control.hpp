...
class C2PowerControl : public VRPowerControl
{
  public:
     ...
     *
     * C2 modifies the handleWaitForHPMPowerGoodDeAssert and handlePowerStateOff
     * handlers to handle the C2 PDB 12V rails.
     *
  ...
  protected:
    /**
     * @brief Validate that all required signals for C2 platform are present in
     * config
     *
     * Checks for C2-specific PDB signals, then calls
  ...
  protected:
     ...
     *
     * Overrides VRPowerControl::handlePowerStateOn() to handle C2-specific
     * monitoring:
     *
     */
     ...
     *
     * PREVIOUS IMPLEMENTATION (C2-specific from powerStateOff in
     * power_control.cpp):
     *
     * Overrides VRPowerControl::handlePowerStateOff() to customize C2 PDB
     * power-on:
     */
     ...
     *
     * PREVIOUS IMPLEMENTATION (C2-specific from
     ...
     *       after PDB powers up, whereas NVL144 only needs to enable E1S/BMC
     * SSD
     */
     ...
     *
     * PREVIOUS IMPLEMENTATION (C2-specific from
     * powerStateWaitForHPMPowerGoodDeAssert):
     *
     * Overrides VRPowerControl::handleWaitForHPMPowerGoodDeAssert() to handle
     * de-assertion of 12V C2 PDB rails:
     *
     */
